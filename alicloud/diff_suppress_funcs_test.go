...
func TestUnitCommonPolardbServrelessTypeDiffSuppressFunc(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			serverlessSteadySwitch: "ON",
			expected:               true,
			description:            "PostgreSQL 15 with SteadyServerless should remain unsupported and suppress diff",
		},
		{
		...
		{
			name:           "Oracle_15_AgileServerless",
			dbType:         "Oracle",
			dbVersion:      "15",
			serverlessType: "AgileServerless",
			expected:       true,
			description:    "Oracle 15 should remain unsupported and suppress diff",
		},
		{
